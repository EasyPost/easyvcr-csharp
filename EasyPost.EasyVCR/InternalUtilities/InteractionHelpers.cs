...
namespace EasyPost.EasyVCR.InternalUtilities
{
    internal static class InteractionHelpers
    {
        ...
        internal static async Task<Request> ToRequestAsync(HttpRequestMessage request, Censors censors)
        {
        ...
        internal static async Task<Response> ToResponseAsync(HttpResponseMessage response, Censors censors)
        {
        ...
        private static IDictionary<string, string> ToHeaders(HttpHeaders headers)
        {
